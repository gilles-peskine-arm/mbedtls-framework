...
class Current(ConfigMacros, generated_files.Generator):
    ...
    # Implement the generated_files.Generator interface
    def generator_name(self) -> str:
        """Name as a generated_files.Generator."""
        return 'options'
