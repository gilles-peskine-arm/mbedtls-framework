...
helper_libtestdriver1_make_main() {
    ...
    make CC=$ASAN_CC CFLAGS="$ASAN_CFLAGS -I../tests/include -I${MBEDTLS_FRAMEWORK}/tests/include -I../tests -I../../tests -DPSA_CRYPTO_DRIVER_TEST -DMBEDTLS_TEST_LIBTESTDRIVER1 $loc_accel_flags" LDFLAGS="-ltestdriver1 $ASAN_CFLAGS" "$@"
}
